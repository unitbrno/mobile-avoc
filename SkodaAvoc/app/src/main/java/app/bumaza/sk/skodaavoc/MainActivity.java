...
import app.bumaza.sk.skodaavoc.utils.EventAdapter;
import app.bumaza.sk.skodaavoc.utils.EventItem;
...
//    private Button mCallApiButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.ides);
            ...
            for (Event event : items) {
                ...
                if (event_description != null) {
                    ...
                    if (event.getAttendees() != null) {
                        ...
                        eventItemList.add(new EventItem(event_description, emails));

//                        eventStrings.add(
//                                String.format("Event: %s Attendees: %s", event_description, emails));
                    } //else
//                        eventStrings.add(
//                                String.format("Event: %s Attendeess: []", event_description));
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
              //  mOutputText.setText("No results returned.");
                ...
                System.out.println("HAHAHSOM U");
                ArrayAdapter<String> itemsAdapter =
                        new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_list_item_1, output);

//                System.out.println(eventItemList.size());
                eventAdapter = new EventAdapter(getBaseContext(), eventItemList);
