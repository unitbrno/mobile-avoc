...
public class CustomAdapter extends BaseAdapter {
    ...
    private List<String> list_chat_models;
    private Context context;
    private LayoutInflater layoutInflater;

    public CustomAdapter(List<String> list_chat_models, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            if(position % 3 == 0)//list_chat_models.get(position).isSend)
            ...
            text_message.setText(list_chat_models.get(position));
